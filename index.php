...
<a class="navbar-brand" href="#"><img src="public/frontend/img/logo.png" class="navbar__img" alt=""> </a>
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="public/frontend/img/hinh1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="public/frontend/img/hinh2.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
...
<footer class="page-footer font-small teal pt-4">
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3">© 2019 Copyright by Girfshop.com
        <a href="#"> Girfshop.com</a>
    </div>
    <!-- Copyright -->
